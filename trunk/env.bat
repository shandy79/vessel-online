...
set PUTTY_BIN=%SOFTWARE_LIB%\putty-0.60

set JAVA_BIN=C:\Program Files\Java\jdk1.6.0_23\bin
set PYTHON_BIN=C:\Python27

set ORIG_PATH=%PATH%
set PATH=%ANT_BIN%;%CVS_BIN%;%DIFF_BIN%;%GREP_BIN%;%PUTTY_BIN%;%JAVA_BIN%;%PYTHON_BIN%;%PATH%
