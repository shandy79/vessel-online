...
set SOFTWARE_LIB=%HOME%\Software
REM set ANT_BIN=%SOFTWARE_LIB%\eclipse-juno\plugins\org.apache.ant_1.8.3.v20120321-1730\bin
REM set CURL_BIN=%SOFTWARE_LIB%\curl-7.33.0
set CURL_BIN=%SOFTWARE_LIB%\curl_winssl64
...
set PUTTY_BIN=%PROGRAMFILES(X86)%\PuTTY
REM set SOAPUI_BIN=%SOFTWARE_LIB%\StandaloneExe\soapui-4.5.2\bin
REM set SVN_BIN=%PROGRAMFILES%\TortoiseSVN\bin
set SVN_BIN=%PROGRAMFILES%\SlikSvn\bin
...
set JDK_HOME=%PROGRAMFILES(X86)%\Java\jdk1.7.0_55
set JDK_BIN=%JDK_HOME%\bin

set JAVA64_HOME=%PROGRAMFILES%\Java\jre7
set JAVA64_BIN=%JAVA64_HOME%\bin

set JDK64_HOME=%PROGRAMFILES%\Java\jdk1.7.0_25
...
set PATH=%CURL_BIN%;%GIT_BIN%;%GRAILS_BIN%;%GREP_BIN%;%PUTTY_BIN%;%SVN_BIN%;%JAVA_BIN%;%PYTHON_HOME%;%PYTHON_SCRIPTS%;%PATH%
