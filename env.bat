...
set SOAPUI_BIN=%SOFTWARE_LIB%\StandaloneExe\soapui-4.5.2\bin
set UNISON_BIN=%SOFTWARE_LIB%\unison-2.32.52
set WGET_BIN=%SOFTWARE_LIB%\wget-1.11.4\bin

set JAVA_HOME=C:\Program Files\Java\jdk1.6.0_35
set JAVA_BIN=%JAVA_HOME%\bin

set M2_HOME=%SOFTWARE_LIB%\apache-maven-3.0.4
set M2=%M2_HOME%\bin
...
set ORIG_PATH=%PATH%
set PATH=%ANT_BIN%;%CVS_BIN%;%DIFF_BIN%;%GREP_BIN%;%PUTTY_BIN%;%SOAPUI_BIN%;%UNISON_BIN%;%WGET_BIN%;%JAVA_BIN%;%M2%;%PYTHON_HOME%;%PYTHON_SCRIPTS%;%PATH%
